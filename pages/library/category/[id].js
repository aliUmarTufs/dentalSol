...
export default function CategorizedArticles() {
  ...
  return (
    <>
      <HeadMeta
        title={`Dent247 | Library | Category | ${
          router?.query?.id ?? "Loading"
        }`}
        description="description"
        content={`Dent247 | Library | Category | ${
          router?.query?.id ?? "Loading"
        }`}
      />
      <div>
        ...
        <div className="bg-light-blue">
          <div className="max-w-7xl mx-auto px-4 lg:px-2 pt-8 md:pt-16 lg:pt-24 pb-8 md:pb-12 lg:pb-20">
            ...
            <InstantSearch searchClient={algoliaClient} indexName="articles">
              <Configure
                filters={`category.label:'${router.query.id}' AND is_approved:1`}
              />
              ...
              <div className="flex flex-col md:flex-row gap-12 md:gap-20">
                <div className="p-5 rounded-2xl w-full md:w-72 h-full bg-bluish-300">
                  ...
                  <div className="mb-10">
                    ...
                    <ResourcesFilterList attribute="article_category_filters.filter_name" />
                  </div>
                  <div className="mb-10">
                    <span className="text-sm text-purplish-800 font-medium">
                      Rating
                ...
                <div className="flex-1">
                  <CategorizedHits
                    entityType={ENTITY_TYPE.ARTICLES}
                    stats={stats}
                  />
                </div>
              </div>
