...
export default function FeaturedDemoModal({ isOpenModal, closeModalHandler }) {
	return (
		<Transition
			show={isOpenModal}
			...
			<Dialog onClose={closeModalHandler} className="relative z-102">
				...
				<div className="fixed inset-0 flex items-center justify-center p-4">
					<Dialog.Panel className="customFeaturedDemo p-2.5 rounded-xl relative w-full max-w-2xl h-4/5 overflow-y-auto rounded bg-white">
						<button
							type="button"
						...
						<Dialog.Description className={"p-4"}>
							<img
								src={"/featured-example-web.png"}
								alt="featured"
								className="hidden sm:block"
							/>
							<img
								src={"/featured-example-mobile.png"}
								alt="featured-mobile"
